    ...
    <div className="min-h-screen flex items-center justify-center bg-game-bg bg-dot-grid bg-gradient-mesh">
      <div className="max-w-lg w-full mx-4">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/15 to-purple-500/15 border border-white/[0.08] mb-5 shadow-lg shadow-blue-500/5">
          ...
          <p className="text-game-secondary text-base font-display tracking-wide">Republic of Novaria</p>
          <div className="flex items-center justify-center gap-3 text-game-muted text-[11px] mt-3 tracking-widest uppercase">
        ...
        {/* Main Menu */}
        {mode === 'menu' && (
          <div className="animate-fade-in hero-card p-2">
